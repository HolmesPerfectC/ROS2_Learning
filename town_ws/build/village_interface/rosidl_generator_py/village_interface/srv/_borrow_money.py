...
class Metaclass_BorrowMoney(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'village_interface.srv.BorrowMoney')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from village_interface.srv import _borrow_money
...
class BorrowMoney(metaclass=Metaclass_BorrowMoney):
    from village_interface.srv._borrow_money import BorrowMoney_Request as Request
    from village_interface.srv._borrow_money import BorrowMoney_Response as Response
