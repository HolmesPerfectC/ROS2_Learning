...
#include "village_interface/msg/detail/novel__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_village_interface
...
using _Novel__ros_msg_type = village_interface__msg__Novel;
...
size_t get_serialized_size_village_interface__msg__Novel(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Novel__ros_msg_type * ros_message = static_cast<const _Novel__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Novel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_village_interface__msg__Novel(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_village_interface
size_t max_serialized_size_village_interface__msg__Novel(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Novel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_village_interface__msg__Novel(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, village_interface, msg, Novel)() {
