...
#include "village_interface/srv/detail/borrow_money__rosidl_typesupport_fastrtps_c.h"
...
using _BorrowMoney_Request__ros_msg_type = village_interface__srv__BorrowMoney_Request;
...
size_t get_serialized_size_village_interface__srv__BorrowMoney_Request(
  const void * untyped_ros_message,
...
static uint32_t _BorrowMoney_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_village_interface__srv__BorrowMoney_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_village_interface
size_t max_serialized_size_village_interface__srv__BorrowMoney_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _BorrowMoney_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_village_interface__srv__BorrowMoney_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, village_interface, srv, BorrowMoney_Request)() {
...
using _BorrowMoney_Response__ros_msg_type = village_interface__srv__BorrowMoney_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_village_interface
size_t get_serialized_size_village_interface__srv__BorrowMoney_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BorrowMoney_Response__ros_msg_type * ros_message = static_cast<const _BorrowMoney_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_village_interface__srv__BorrowMoney_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_village_interface
size_t max_serialized_size_village_interface__srv__BorrowMoney_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _BorrowMoney_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_village_interface__srv__BorrowMoney_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, village_interface, srv, BorrowMoney_Response)() {
...
// already included above
// #include "village_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "village_interface/srv/borrow_money.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, village_interface, srv, BorrowMoney)() {
