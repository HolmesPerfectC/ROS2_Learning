...
#include "village_interface/srv/detail/sell_novel__rosidl_typesupport_fastrtps_c.h"
...
using _SellNovel_Request__ros_msg_type = village_interface__srv__SellNovel_Request;
...
size_t get_serialized_size_village_interface__srv__SellNovel_Request(
  const void * untyped_ros_message,
...
static uint32_t _SellNovel_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_village_interface__srv__SellNovel_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_village_interface
size_t max_serialized_size_village_interface__srv__SellNovel_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SellNovel_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_village_interface__srv__SellNovel_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, village_interface, srv, SellNovel_Request)() {
...
using _SellNovel_Response__ros_msg_type = village_interface__srv__SellNovel_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_village_interface
size_t get_serialized_size_village_interface__srv__SellNovel_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SellNovel_Response__ros_msg_type * ros_message = static_cast<const _SellNovel_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_village_interface__srv__SellNovel_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_village_interface
size_t max_serialized_size_village_interface__srv__SellNovel_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SellNovel_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_village_interface__srv__SellNovel_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, village_interface, srv, SellNovel_Response)() {
...
// already included above
// #include "village_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "village_interface/srv/sell_novel.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, village_interface, srv, SellNovel)() {
