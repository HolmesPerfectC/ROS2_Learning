...
static const _BorrowMoney_Request_type_support_symbol_names_t _BorrowMoney_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, village_interface, srv, BorrowMoney_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, village_interface, srv, BorrowMoney_Request)),
  }
};
...
{
  return &::village_interface::srv::rosidl_typesupport_cpp::BorrowMoney_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, village_interface, srv, BorrowMoney_Request)() {
  return get_message_type_support_handle<village_interface::srv::BorrowMoney_Request>();
}
...
static const _BorrowMoney_Response_type_support_symbol_names_t _BorrowMoney_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, village_interface, srv, BorrowMoney_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, village_interface, srv, BorrowMoney_Response)),
  }
};
...
{
  return &::village_interface::srv::rosidl_typesupport_cpp::BorrowMoney_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, village_interface, srv, BorrowMoney_Response)() {
  return get_message_type_support_handle<village_interface::srv::BorrowMoney_Response>();
}
...
static const _BorrowMoney_type_support_symbol_names_t _BorrowMoney_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, village_interface, srv, BorrowMoney)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, village_interface, srv, BorrowMoney)),
  }
};
...
{
  return &::village_interface::srv::rosidl_typesupport_cpp::BorrowMoney_service_type_support_handle;
}
