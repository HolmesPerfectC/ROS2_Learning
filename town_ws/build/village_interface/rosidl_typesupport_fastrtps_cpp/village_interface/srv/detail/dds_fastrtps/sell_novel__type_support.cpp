...
#include "village_interface/srv/detail/sell_novel__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const village_interface::srv::SellNovel_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<village_interface::srv::SellNovel_Request *>(
    untyped_ros_message);
...
{
  return &village_interface::srv::typesupport_fastrtps_cpp::_SellNovel_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const village_interface::srv::SellNovel_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<village_interface::srv::SellNovel_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &village_interface::srv::typesupport_fastrtps_cpp::_SellNovel_Response__handle;
}
...
{
  return &village_interface::srv::typesupport_fastrtps_cpp::_SellNovel__handle;
}
