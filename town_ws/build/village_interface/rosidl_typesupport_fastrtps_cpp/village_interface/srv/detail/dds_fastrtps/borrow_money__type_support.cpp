...
#include "village_interface/srv/detail/borrow_money__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const village_interface::srv::BorrowMoney_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  village_interface::srv::BorrowMoney_Request & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
{
  auto typed_message =
    static_cast<const village_interface::srv::BorrowMoney_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<village_interface::srv::BorrowMoney_Request *>(
    untyped_ros_message);
...
{
  return &village_interface::srv::typesupport_fastrtps_cpp::_BorrowMoney_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, village_interface, srv, BorrowMoney_Request)() {
  return &village_interface::srv::typesupport_fastrtps_cpp::_BorrowMoney_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_village_interface
cdr_serialize(
  const village_interface::srv::BorrowMoney_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  village_interface::srv::BorrowMoney_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const village_interface::srv::BorrowMoney_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<village_interface::srv::BorrowMoney_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &village_interface::srv::typesupport_fastrtps_cpp::_BorrowMoney_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, village_interface, srv, BorrowMoney_Response)() {
  return &village_interface::srv::typesupport_fastrtps_cpp::_BorrowMoney_Response__handle;
}
...
{
  return &village_interface::srv::typesupport_fastrtps_cpp::_BorrowMoney__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, village_interface, srv, BorrowMoney)() {
  return &village_interface::srv::typesupport_fastrtps_cpp::_BorrowMoney__handle;
}
