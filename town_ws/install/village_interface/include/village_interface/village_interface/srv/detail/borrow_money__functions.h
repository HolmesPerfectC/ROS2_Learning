...
#ifndef VILLAGE_INTERFACE__SRV__DETAIL__BORROW_MONEY__FUNCTIONS_H_
#define VILLAGE_INTERFACE__SRV__DETAIL__BORROW_MONEY__FUNCTIONS_H_
 ...
 * calls
 * village_interface__srv__BorrowMoney_Request__init().
...
/**
 * It calls
 * village_interface__srv__BorrowMoney_Request__fini()
 ...
 * village_interface__srv__BorrowMoney_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * village_interface__srv__BorrowMoney_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * village_interface__srv__BorrowMoney_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_village_interface
...
/**
 * It calls
 * village_interface__srv__BorrowMoney_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_village_interface
...
/**
 * It allocates the memory for the array and calls
 * village_interface__srv__BorrowMoney_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_village_interface
...
/**
 * It calls
 * village_interface__srv__BorrowMoney_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VILLAGE_INTERFACE__SRV__DETAIL__BORROW_MONEY__FUNCTIONS_H_
