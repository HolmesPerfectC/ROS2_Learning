...
bool village_interface__msg__novel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("village_interface.msg._novel.Novel", full_classname_dest, 34) == 0);
  }
  village_interface__msg__Novel * ros_message = _ros_message;
  {  // content
...
PyObject * village_interface__msg__novel__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("village_interface.msg._novel");
