...
class Metaclass_SellNovel(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'village_interface.srv.SellNovel')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from village_interface.srv import _sell_novel
...
class SellNovel(metaclass=Metaclass_SellNovel):
    from village_interface.srv._sell_novel import SellNovel_Request as Request
    from village_interface.srv._sell_novel import SellNovel_Response as Response
